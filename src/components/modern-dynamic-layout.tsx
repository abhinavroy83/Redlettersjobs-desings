...
import { Search, Briefcase, Users, BookOpen, ChevronRight, Menu } from "lucide-react"
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
              ...
              <div className="flex justify-center space-x-4 text-sm">
                ...
                <a href="#" className="text-blue-600 hover:underline">Browse All Jobs</a>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} className="hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-gray-700">{category.count}+ Jobs</p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
              Stay updated with the latest opportunities and resources in Christian careers.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-sm mb-4">
                Red Letter Jobs is dedicated to connecting passionate individuals with meaningful careers in Christian ministry and non-profit sectors.
              </p>
